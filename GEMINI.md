...
## Context & Status
- **Goal:** Implement cliprs functionality according to AGENTS.md, followed by architectural refactoring.
...
- **Why:** Existing cliprs implementation for system integration.
